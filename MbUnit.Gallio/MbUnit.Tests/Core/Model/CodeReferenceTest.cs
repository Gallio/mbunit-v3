...
namespace MbUnit.Tests.Core.Model
{
    ...
    public class CodeReferenceTest
    {
        ...
        [Test]
        public void ToInfo_WithNullValues()
        {
            CodeReferenceInfo info = CodeReference.Unknown.ToInfo();
        ...
        [Test]
        public void ToInfo_WithNonNullValues()
        {
            CodeReferenceInfo info = CodeReference.CreateFromParameter(parameter).ToInfo();
