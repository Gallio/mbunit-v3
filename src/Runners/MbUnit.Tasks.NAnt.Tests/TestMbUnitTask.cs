...
{
    /// <summary>
    /// Makes possible to unit tests the MbUnit.Tasks.NAnt.MbUnitNAntTask class.
    /// </summary>
    /// <remarks>
    ...
    /// interface too.
    /// </remarks>
    public class TestMbUnitTask : MbUnitNAntTask
    {
        ...
        public TestMbUnitTask(INAntLogger nantLogger)
            : base(nantLogger)
        {
        }
