...
{
    /// <summary>
    /// Makes possible to unit test the <see cref="MbUnitTask" /> class.
    ...
    /// interface too.
    /// </remarks>
    public class InstrumentedMbUnitTask : MbUnitTask
    {
        ...
        public InstrumentedMbUnitTask(INAntLogger nantLogger)
            : base(nantLogger)
        {
        }
