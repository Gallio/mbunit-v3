...
{
    internal sealed class MetadataPointerTypeWrapper : MetadataConstructedTypeWrapper<IMetadataPointerType>
    {
        public MetadataPointerTypeWrapper(MetadataReflector reflector, IMetadataPointerType target)
        ...
        {
            get { return Gallio.Reflection.Reflector.Wrap(typeof(Pointer)); }
        }
    }
}