...
{
    internal sealed class PsiArrayTypeWrapper : PsiConstructedTypeWrapper<IArrayType>
    {
        public PsiArrayTypeWrapper(PsiReflector reflector, IArrayType target)
        ...
        public override ITypeInfo EffectiveClassType
        {
            get
            {
                return Gallio.Reflection.Reflector.Wrap(typeof(Array));
            }
        }
    }
}