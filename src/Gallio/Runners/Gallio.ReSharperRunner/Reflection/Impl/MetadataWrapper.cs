...
{
    internal abstract class MetadataWrapper<TTarget>
        where TTarget : class
    {
        private readonly MetadataReflector reflector;
        private readonly TTarget target;

        public MetadataWrapper(MetadataReflector reflector, TTarget target)
        {
            if (reflector == null)
        ...
        {
            MetadataWrapper<TTarget> other = obj as MetadataWrapper<TTarget>;
