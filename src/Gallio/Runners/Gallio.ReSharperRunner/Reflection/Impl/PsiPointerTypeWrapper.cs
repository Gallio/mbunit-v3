...
{
    internal sealed class PsiPointerTypeWrapper : PsiConstructedTypeWrapper<IPointerType>
    {
        public PsiPointerTypeWrapper(PsiReflector reflector, IPointerType target)
        ...
        public override ITypeInfo EffectiveClassType
        {
            get
            {
                return Gallio.Reflection.Reflector.Wrap(typeof(Pointer));
            }
        }
    }
}