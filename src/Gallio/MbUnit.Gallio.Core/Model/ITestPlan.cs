...
namespace MbUnit.Core.Model
{
    ...
    /// finds a <see cref="IMasterTest" /> in the tree.</item>
    /// <item>When a <see cref="IMasterTest" /> is found, the test plan calls
    /// <see cref="IMasterTest.CreateTestController" /> to create a controller.
    /// Then it invokes <see cref="ITestController.RunTests" /> and passes in
    /// a <see cref="ITestMonitor" /> corresponding to the <see cref="IMasterTest" />
    /// that was found.</item>
