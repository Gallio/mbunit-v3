...
namespace MbUnit.Core.Services.ExecutionLogs.Xml
{
    ...
    [Serializable]
    public sealed class XmlExecutionLogStreamTextTag : XmlExecutionLogStreamTag
    {
        private string text;
        ...
        public static XmlExecutionLogStreamTextTag Create(string text)
        {
            XmlExecutionLogStreamTextTag tag = new XmlExecutionLogStreamTextTag();
            tag.text = text;
            return tag;
        }
    }
