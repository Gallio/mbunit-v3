...
namespace MbUnit.Core.Services.ExecutionLogs.Xml
{
    ...
    [Serializable]
    public sealed class XmlExecutionLogStreamSectionTag : XmlExecutionLogStreamContainerTag
    {
        private string name;
        ...
        public static XmlExecutionLogStreamSectionTag Create(string sectionName)
        {
            XmlExecutionLogStreamSectionTag tag = new XmlExecutionLogStreamSectionTag();
            tag.Initialize();
