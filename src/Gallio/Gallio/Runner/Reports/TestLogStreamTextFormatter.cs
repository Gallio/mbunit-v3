...
namespace Gallio.Runner.Reports
{
    /// <summary>
    /// <para>
    /// Formats <see cref="TestLogStreamTag" /> instances to plain text.
    /// </para>
    /// <para>
    ...
    /// </para>
    /// </summary>
    public class TestLogStreamTextFormatter : ITestLogStreamTagVisitor
    {
        ...
        /// <inheritdoc />
        public virtual void VisitBodyTag(TestLogStreamBodyTag tag)
        {
        ...
        /// <inheritdoc />
        public virtual void VisitSectionTag(TestLogStreamSectionTag tag)
        {
            RequestMinimumSpacing(2);
            Append(tag.Name);
        ...
        /// <inheritdoc />
        public virtual void VisitMarkerTag(TestLogStreamMarkerTag tag)
        {
            tag.AcceptContents(this);
        }

        /// <inheritdoc />
        public virtual void VisitEmbedTag(TestLogStreamEmbedTag tag)
        {
            RequestMinimumSpacing(1);
        ...
        /// <inheritdoc />
        public virtual void VisitTextTag(TestLogStreamTextTag tag)
        {
            Append(tag.Text);
        }
