...
namespace Gallio.Runner.Reports
{
    ...
    public sealed class TestLogStream
    {
        private string name;
        private TestLogStreamBodyTag body;

        /// <summary>
        /// Creates an uninitialized instance for Xml deserialization.
        /// </summary>
        private TestLogStream()
        {
        }
        ...
        public TestLogStreamBodyTag Body
        {
            get
            {
                if (body == null)
                    body = new TestLogStreamBodyTag();
                return body;
            }
            set
            {
        ...
        /// <summary>
        /// Formats the stream using a <see cref="TestLogStreamTextFormatter" />.
        /// </summary>
