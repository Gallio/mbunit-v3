...
namespace Gallio.Runner.Harness
{
    ...
    /// A test thread task.
    /// </summary>
    public class TestThreadTask : ThreadTask
    {
        ...
        public TestThreadTask(string name, Func<object> func, ITestEnvironmentManager environmentManager)
            : base(name, func)
        {
        ...
        public TestThreadTask(string name, Action action, ITestEnvironmentManager environmentManager)
            : base(name, action)
        {
            this.environmentManager = ResolveTestEnvironmentManager(environmentManager);
        }
