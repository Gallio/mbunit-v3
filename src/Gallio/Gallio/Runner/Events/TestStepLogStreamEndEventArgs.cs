...
namespace Gallio.Runner.Events
{
    ...
    /// </summary>
    public sealed class TestStepLogStreamEndEventArgs : TestStepLogStreamEventArgs
    {
        /// <summary>
        ...
        public TestStepLogStreamEndEventArgs(Report report, TestData test, TestStepRun testStepRun, string logStreamName)
