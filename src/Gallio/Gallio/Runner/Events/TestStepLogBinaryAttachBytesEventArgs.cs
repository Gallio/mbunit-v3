...
namespace Gallio.Runner.Events
{
    ...
    /// </summary>
    public sealed class TestStepLogBinaryAttachBytesEventArgs : TestStepLogAttachArgs
    {
        ...
        public TestStepLogBinaryAttachBytesEventArgs(Report report, TestData test, TestStepRun testStepRun, string attachmentName, string contentType, byte[] bytes)
