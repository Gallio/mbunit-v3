...
namespace Gallio.Common.Xml
{
    ...
    /// </summary>
    public class Attribute : IDiffable<Attribute>, IMarkup
    {
        ...
        public Attribute(int index, string name, string value, int count)
        {
            if (index < 0)
        ...
        /// <inheritdoc />
        public DiffSet Diff(IMarkup expected, IXmlPathStrict path, Options options)
        {
            return Diff((Attribute) expected, path, options);
        }

        /// <inheritdoc />
        public DiffSet Diff(Attribute expected, IXmlPathStrict path, Options options)
        {
            if (expected == null)
