...
{
    /// <summary>
    /// Concrete node representing an XML declaration markup in a strict path, and which is closed to further extensions.
    /// </summary>
    internal sealed class XmlPathStrictDeclaration : XmlPathStrict
    {
        /// <summary>
        /// Constructs a node that extends the specified root node by targetting the declaration markup.
        /// </summary>
