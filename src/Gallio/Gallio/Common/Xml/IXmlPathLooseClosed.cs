...
{
    /// <summary>
    /// Represents a closed immutable and loose path to a markup in an XML fragment.
    /// </summary>
    /// <remarks>
    /// <para>
    /// A closed path points to a type of markup that has no child, like an attribute.
    /// </para>
    /// </remarks>
    /// <remarks>
    /// <para>
