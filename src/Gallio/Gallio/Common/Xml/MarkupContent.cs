...
namespace Gallio.Common.Xml
{
    ...
    /// </summary>
    public class MarkupContent : MarkupBase, IDiffable<MarkupContent>
    {
        ...
        public MarkupContent(int index, string text)
        ...
        {
            var expectedContent = expected as MarkupContent;
        ...
        /// <inheritdoc />
        public DiffSet Diff(MarkupContent expected, IXmlPathStrict path, Options options)
        {
            if (expected == null)
