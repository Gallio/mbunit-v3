...
namespace Gallio.Hosting
{
    ...
    /// <see cref="IRemoteHostService" /> suitable for access across a remoting channel.
    /// </summary>
    /// <see cref="HostServiceChannelInterop"/>
    public class HostService : LongLivingMarshalByRefObject, IRemoteHostService
    {
        ...
        public HostService(TimeSpan? watchdogTimeout)
        {
