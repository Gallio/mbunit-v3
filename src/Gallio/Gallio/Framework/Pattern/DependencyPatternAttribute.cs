    ...
    public abstract class DependencyPatternAttribute : PatternAttribute
    {
        ...
        public override void ProcessTest(IPatternTestBuilder testBuilder, ICodeElementInfo codeElement)
        {
            testBuilder.AddDecorator(int.MaxValue, delegate
            {
                ...
                foreach (IPatternTestBuilder dependentTestBuilder in testBuilder.TestModelBuilder.GetTestBuilders(resolvedDependency))
        ...
        protected abstract ICodeElementInfo GetDependency(IPatternTestBuilder testBuilder, ICodeElementInfo codeElemeent);
    }
}