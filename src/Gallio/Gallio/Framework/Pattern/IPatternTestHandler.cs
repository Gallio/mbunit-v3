...
namespace Gallio.Framework.Pattern
{
    ...
    public interface IPatternTestHandler
    {
        ...
        /// <summary>
        /// <para>
        /// Decorates the <see cref="IPatternTestHandler" /> of a child test before its
        /// <see cref="BeforeTest" /> actions have a chance to run.
        /// </para>
        /// <para>
        /// This method runs in the <see cref="Context" /> of the test instance
        /// in the <see cref="LifecyclePhases.Execute" /> lifecycle phase.
        ...
        /// by adding actions to the supplied <paramref name="decoratedChildActions" /> object.
        ...
        /// The following actions are typically performed during this phase:
        /// <list type="bullet">
        /// <item>Adding additional actions for the child test to the <paramref name="decoratedChildActions"/>.</item>
        /// <item>Accessing user data via <see cref="PatternTestInstanceState.Data" />.</item>
        /// </list>
        /// </para>
        /// <para>
        ...
        /// <paramref name="decoratedChildActions"/> will be invoked with references to the
        ...
        /// </remarks>
        /// <param name="testInstanceState">The test instance state, never null</param>
        /// <param name="decoratedChildActions">The child's actions to decorate, never null</param>
        void DecorateChildTest(PatternTestInstanceState testInstanceState, PatternTestActions decoratedChildActions);
    }
}
