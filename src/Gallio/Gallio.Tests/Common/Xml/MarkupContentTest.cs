...
{
    [TestFixture]
    [TestsOn(typeof(MarkupContent))]
    public class MarkupContentTest : DiffableTestBase
    {
        [Test]
        [ExpectedArgumentOutOfRangeException]
        public void Constructs_with_negative_index_should_throw_exception()
        {
            new MarkupContent(-1, "blah blah");
        }
        ...
        {
            new MarkupContent(0, null);
        }

        [Test]
        public void Constructs_ok([Column(0, 123)] int index)
        {
            var comment = new MarkupContent(index, " Jack Burton ");
        ...
        {
            var actual = new MarkupContent(123, "Text");
        ...
        {
            var actual = new MarkupContent(123, "Text");
            var expected = new MarkupContent(123, "Text");
        ...
        {
            var actual = new MarkupContent(123, "Text");
            var expected = new MarkupContent(456, "Text");
