...
namespace Gallio.Tests.Common.Xml
{
    ...
    public class FragmentTest
    {
        ...
        {
            new Fragment(new Declaration(AttributeCollection.Empty), null);
        }
        ...
        {
            var mockRoot = MockRepository.GenerateStub<IMarkup>();
            new Fragment(null, mockRoot);
        }
        ...
        public void Constructs_empty()
        {
            ...
            var document = new Fragment(declaration, mockRoot);
