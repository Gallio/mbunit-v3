...
namespace Gallio.Tests.Framework.Data
{
    ...
    public class SlotBinderNegativeTest : BaseUnitTest
    {
        ...
        public void FormatSlotValuesThrowsWhenSlotValuesIsNull()
        {
            SlotBinder.FormatSlotValues(null, Mocks.Stub<IFormatter>());
        }

        [Test, ExpectedArgumentNullException]
        public void FormatSlotValuesThrowsWhenFormatterIsNull()
        {
            SlotBinder.FormatSlotValues(EmptyArray<KeyValuePair<ISlotInfo, object>>.Instance, null);
        }

        [Test, ExpectedArgumentNullException]
        public void MakeTypeThrowsWhenTypeIsNull()
        {
            SlotBinder.MakeType(null, EmptyArray<KeyValuePair<ISlotInfo, object>>.Instance);
        }

        [Test, ExpectedArgumentNullException]
        public void MakeTypeThrowsWhenSlotValuesIsNull()
        {
            SlotBinder.MakeType(NonGenericClassInfo, null);
        }

        [Test, ExpectedArgumentNullException]
        public void MakeTypeThrowsWhenSlotValuesContainsANullSlot()
        {
            SlotBinder.MakeType(NonGenericClassInfo, new KeyValuePair<ISlotInfo, object>[]
                {
        ...
        public void MakeTypeThrowsWhenTypeIsAGenericClassParameter()
        {
            SlotBinder.MakeType(GenericClassParamInfo, EmptyArray<KeyValuePair<ISlotInfo, object>>.Instance);
        }

        [Test, ExpectedArgumentException]
        public void MakeTypeThrowsWhenTypeIsAnArray()
        {
            ITypeInfo type = Reflector.Wrap(typeof(NonGenericClass[]));
            SlotBinder.MakeType(type, EmptyArray<KeyValuePair<ISlotInfo, object>>.Instance);
        }

        [Test, ExpectedArgumentException]
        public void MakeTypeThrowsWhenTypeIsAPointer()
        {
        ...
        [Test, ExpectedArgumentException]
        public void MakeTypeThrowsWhenTypeIsAByRef()
        {
        ...
        [Test, ExpectedArgumentException]
        public void MakeTypeThrowsWhenGenericClassParamSlotBelongsToDifferentType()
        {
            Dictionary<ISlotInfo, object> slotValues = new Dictionary<ISlotInfo, object>();
            slotValues.Add(GenericClassParamInfo, 42);

            SlotBinder.MakeType(GenericClassInstInfo, slotValues);
        }

        [Test, ExpectedArgumentException]
        public void MakeTypeThrowsWhenMethodParamSlotUsedInsteadOfAConstructorParam()
        {
            Dictionary<ISlotInfo, object> slotValues = new Dictionary<ISlotInfo, object>();
            slotValues.Add(NonGenericClassMethodInfo.Parameters[0], 42);

            SlotBinder.MakeType(NonGenericClassInfo, slotValues);
        }

        [Test, ExpectedArgumentException]
        public void MakeTypeThrowsWhenMissingGenericParamSlotForGenericClassDef()
        {
            Dictionary<ISlotInfo, object> slotValues = new Dictionary<ISlotInfo, object>();

            SlotBinder.MakeType(GenericClassDefInfo, slotValues);
        }

        [Test, ExpectedArgumentException]
        public void MakeTypeThrowsWhenGenericParamSlotForGenericClassDefIsNull()
        {
            Dictionary<ISlotInfo, object> slotValues = new Dictionary<ISlotInfo, object>();
        ...
        [Test, ExpectedArgumentException]
        public void MakeTypeThrowsWhenGenericParamSlotForGenericClassDefIsNotAssignedToAType()
        {
            Dictionary<ISlotInfo, object> slotValues = new Dictionary<ISlotInfo, object>();
            slotValues.Add(GenericClassParamInfo, 42);
