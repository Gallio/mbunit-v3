...
namespace Gallio.Tests.Framework.Data
{
    ...
    public class SlotBinderPositiveTest : BaseUnitTest
    {
        ...
        [Test]
        public void FormatSlotValuesReturnsAnEmptyStringIfThereAreNoSlots()
        {
            Assert.AreEqual("", SlotBinder.FormatSlotValues(EmptyArray<KeyValuePair<ISlotInfo, object>>.Instance,
                Mocks.Stub<IFormatter>()));
        }

        [Test, Pending]
        public void FormatSlotValues()
        {
        }

        [Test]
        public void MakeTypeWithGenericClass()
        {
            ...
            Type typeInstantiation = SlotBinder.MakeType(type, slotValues);
            Assert.AreEqual(typeof(Class<int>), typeInstantiation);
        }

        [Test]
        public void MakeTypeWithGenericClassInstantiation()
        {
