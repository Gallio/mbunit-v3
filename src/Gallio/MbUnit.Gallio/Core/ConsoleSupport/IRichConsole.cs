...
namespace MbUnit.Core.ConsoleSupport
{
    ...
    public interface IRichConsole
    {
        ...
        /// </para>
        /// <para>
        /// The <see cref="SystemConsole.Cancel" /> event handlers will be called
        /// when the value of <see cref="SystemConsole.IsCanceled" /> transitions from
        ...
        /// </summary>
        /// <exception cref="IOException">Thrown if <see cref="SystemConsole.IsRedirected" /> is true</exception>
        int CursorLeft
        {
            get;
            set;
