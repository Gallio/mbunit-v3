...
namespace MbUnit.Core.Runner
{
    ...
    public class LocalRunner : BaseRunner
    {
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">Thrown if <see cref="Runtime.Instance" /> is null</exception>
        public LocalRunner()
            : this(GetRuntime())
        {
        }
        ...
        public LocalRunner(IRuntime runtime)
        ...
        {
            IRuntime runtime = MbUnit.Core.RuntimeSupport.Runtime.Instance;
            if (runtime == null)
