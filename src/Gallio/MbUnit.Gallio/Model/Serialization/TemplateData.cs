...
namespace MbUnit.Model.Serialization
{
    /// <summary>
    ...
    public sealed class TemplateData : TemplateComponentData
    {
        ...
        [XmlArrayItem("template", typeof(TemplateData), IsNullable=false)]
        ...
        [XmlArrayItem("parameter", typeof(TemplateParameterData), IsNullable = false)]
