...
namespace Gallio.MbUnitCppAdapter.Model.Bridge
{
    ...
    public struct NativeAssertionFailure
    {
        ...
        /// <summary>
        /// The ID of the string that holds the text version of the actual value.
        /// </summary>
        /// <remarks>
        /// <para>
        /// Zero if the failure does not involve any actual value.
        /// </para>
        /// </remarks>
        public int ActualValueId;

        /// <summary>
        /// The native type of the actual value.
        /// </summary>
        /// <remarks>
        /// <para>
        /// Ignore if <paramref name="ActualValueId"/> is zero.
        /// </para>
        /// </remarks>
        public NativeValueType ActualValueType;

        /// <summary>
        /// The ID of the string that holds the text version of the expected value.
        /// </summary>
        /// <remarks>
        /// <para>
        /// Zero if the failure does not involve any expected value.
        /// </para>
        /// </remarks>
