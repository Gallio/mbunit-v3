...
namespace Gallio.Icarus.AdapterModel.Tests
{
    ...
    public class ProjectAdapterModelTest : MockTest
    {
        ...
        private TestModelData CreateTestModel()
        {
            ...
            framework.Metadata.SetValue(MetadataKeys.TestKind, TestKinds.Framework);
            rootTest.Children.Add(framework);
            TestData assembly = new TestData("Assembly", "Assembly", "Assembly");
            assembly.Metadata.SetValue(MetadataKeys.TestKind, TestKinds.Assembly);
            ...
            fixture.Metadata.SetValue(MetadataKeys.TestKind, TestKinds.Fixture);
            ...
            test2.Metadata.SetValue(MetadataKeys.TestKind, TestKinds.Test);
            ...
            fixture2.Metadata.SetValue(MetadataKeys.TestKind, TestKinds.Fixture);
            assembly.Children.Add(fixture2);
            TestData test3 = new TestData("Test3", "Test3", "Test3");
            test3.Metadata.SetValue(MetadataKeys.TestKind, TestKinds.Test);
