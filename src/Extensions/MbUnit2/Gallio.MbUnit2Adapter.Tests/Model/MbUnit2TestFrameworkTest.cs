...
namespace Gallio.MbUnit2Adapter.Tests.Model
{
    ...
    public class MbUnit2TestFrameworkTest : BaseTestFrameworkTest
    {
        ...
        public void PopulateTestTree_CapturesTestStructureAndBasicMetadata()
        {
            ...
            Assert.AreEqual(new CodeReference(sampleAssembly.FullName, "Gallio.MbUnit2Adapter.TestResources", "Gallio.MbUnit2Adapter.TestResources.SimpleTest", null, null),
            ...
            Assert.AreEqual(new CodeReference(sampleAssembly.FullName, "Gallio.MbUnit2Adapter.TestResources", "Gallio.MbUnit2Adapter.TestResources.SimpleTest", "Pass", null),
            ...
            Assert.AreEqual(new CodeReference(sampleAssembly.FullName, "Gallio.MbUnit2Adapter.TestResources", "Gallio.MbUnit2Adapter.TestResources.SimpleTest", "Fail", null),
        ...
        public void MetadataImport_AssemblyAttributes()
        {
            ...
            Assert.AreEqual("Gallio.MbUnit2Adapter.TestResources", assemblyTest.Metadata.GetValue(MetadataKeys.Title));
