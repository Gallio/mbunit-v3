...
namespace Gallio.VisualStudio.Shell.ToolWindows
{
    ...
    /// </summary>
    public abstract class ToolWindow : ShellComponent
    {
        ...
        /// <paramref name="controlType"/>, or <paramref name="caption"/> is null</exception>
        public ToolWindow(IShell shell, Type controlType, Guid guid, string caption)
            : base(shell)
        {
            if (controlType == null)
