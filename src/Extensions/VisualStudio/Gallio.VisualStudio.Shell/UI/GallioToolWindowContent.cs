...
namespace Gallio.VisualStudio.Shell.UI
{
    ...
    /// </summary>
    public abstract class GallioToolWindowContent : UserControl, IShellComponent
    {
        /// <summary>
        ...
        /// </summary>
        protected GallioToolWindowContent()
        {
        }
        ...
        protected GallioToolWindowContent(IShell shell)
        {
            if (shell == null)
            {
