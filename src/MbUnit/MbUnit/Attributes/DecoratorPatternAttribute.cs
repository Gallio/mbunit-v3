...
{
    /// <summary>
    /// A decorator attribute applies contributions to a model object (usually a template)
    /// generated by some other pattern attribute.  Occasionally the order in which
    /// decorators are applied is significant so this type provides a <see cref="Order" />
    /// property to specify an explicit ordering when required.
    /// </summary>
