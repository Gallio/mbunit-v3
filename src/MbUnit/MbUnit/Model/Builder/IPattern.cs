...
namespace MbUnit.Model.Builder
{
    ...
    /// <see cref="MbUnitTest" /> and <see cref="MbUnitTestParameter" /> objects
    /// using reflection.
    /// </para>
    /// <para>
    /// The general idea is that a pattern can apply any number of contributions to the
    /// <see cref="ITestBuilder" /> or <see cref="ITestParameterBuilder" />
    ...
    /// </para>
    /// <para>
    /// The entire MbUnit test model construction process is built up in this way.
    ...
    public interface IPattern
    {
        ...
        bool Consume(ITestBuilder containingTestBuilder, ICodeElementInfo codeElement);
        ...
        /// <param name="codeElement">The code element to process</param>
        void ProcessTest(ITestBuilder testBuilder, ICodeElementInfo codeElement);
        ...
        /// <param name="codeElement">The code element to process</param>
        void ProcessTestParameter(ITestParameterBuilder testParameterBuilder, ICodeElementInfo codeElement);
    }
}
