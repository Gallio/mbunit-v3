...
namespace MbUnit.Framework.Xml
{
    ...
    public class Attribute : IDiffable<Attribute>, INamed
    {
        ...
        /// <inheritdoc />
        public DiffSet Diff(Attribute expected, Path path, XmlEqualityOptions options)
        {
            if (expected == null)
        ...
        {
            return (((options & XmlEqualityOptions.IgnoreAttributesNameCase) != 0) 
        ...
        {
            return (((options & XmlEqualityOptions.IgnoreAttributesValueCase) != 0)
                ? StringComparison.CurrentCultureIgnoreCase
                : StringComparison.CurrentCulture);
        }
