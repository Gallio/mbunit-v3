...
namespace MbUnit.Framework
{
    ...
    public abstract class Assert
    {
        ...
        /// <exception cref="AssertionException">Thrown if the verification failed unless the current <see cref="AssertionContext.AssertionFailureBehavior" /> indicates otherwise</exception>
        public static void AreElementsEqual<T>(IEnumerable<T> exectedCollection, IEnumerable<T> actualCollection)
        {
            AreElementsEqual(exectedCollection, actualCollection, null, null, null);
        }
        ...
        /// <param name="messageArgs">The custom assertion message arguments, or null if none</param>
        /// <exception cref="AssertionException">Thrown if the verification failed unless the current <see cref="AssertionContext.AssertionFailureBehavior" /> indicates otherwise</exception>
        public static void AreElementsEqual<T>(IEnumerable<T> exectedCollection, IEnumerable<T> actualCollection, string messageFormat, params object[] messageArgs)
        {
            AreElementsEqual(exectedCollection, actualCollection, null, messageFormat, messageArgs);
        }
        ...
        /// <param name="comparer">The comparer to use, or null to use the default one</param>
        /// <exception cref="AssertionException">Thrown if the verification failed unless the current <see cref="AssertionContext.AssertionFailureBehavior" /> indicates otherwise</exception>
        public static void AreElementsEqual<T>(IEnumerable<T> exectedCollection, IEnumerable<T> actualCollection, Func<IEnumerable<T>, IEnumerable<T>, bool> comparer)
        {
            AreElementsEqual(exectedCollection, actualCollection, comparer, null, null);
        }
        ...
        /// <param name="messageArgs">The custom assertion message arguments, or null if none</param>
        /// <exception cref="AssertionException">Thrown if the verification failed unless the current <see cref="AssertionContext.AssertionFailureBehavior" /> indicates otherwise</exception>
        public static void AreElementsEqual<T>(IEnumerable<T> exectedCollection, IEnumerable<T> actualCollection, Func<IEnumerable<T>, IEnumerable<T>, bool> comparer, string messageFormat, params object[] messageArgs)
        {
            AssertionHelper.Verify(delegate
            {
                if (comparer == null)
