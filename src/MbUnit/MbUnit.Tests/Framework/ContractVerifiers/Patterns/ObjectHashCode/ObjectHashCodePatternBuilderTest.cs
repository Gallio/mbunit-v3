...
{
    [TestFixture]
    public class ObjectHashCodePatternBuilderTest
    {
        ...
        {
            new ObjectHashCodePatternBuilder().SetTargetType(null);
        }
        ...
        {
            new ObjectHashCodePatternBuilder()
                .ToPattern();
        }
        ...
        {
            var pattern = new ObjectHashCodePatternBuilder()
                .SetTargetType(typeof(object))
                .ToPattern();
            Assert.IsNotNull(pattern);
            Assert.IsInstanceOfType(typeof(ObjectHashCodePattern), pattern);
        }
    }
}
