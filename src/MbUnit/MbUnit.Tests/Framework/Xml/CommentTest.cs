...
namespace MbUnit.Tests.Framework.Xml
{
    ...
    public class CommentTest : DiffableTestBase
    {
        ...
        {
            var comment = new Comment(" Jack Burton ");
            comment.Diff(null, Path.Empty, XmlEqualityOptions.Default);
        }
        ...
        public void Diff_with_null_pathshould_throw_exception()
        {
            ...
            comment1.Diff(comment2, null, XmlEqualityOptions.Default);
        }
        ...
        public void Diff_inequal_comments()
        {
            var comment1 = new Comment("Chapi");
            var comment2 = new Comment("Chapo");
            DiffSet diffSet = comment1.Diff(comment2, Path.Empty, XmlEqualityOptions.Strict);
        ...
        public void Diff_while_ignoring_comments()
        {
            var comment1 = new Comment("Chapi");
            var comment2 = new Comment("Chapo");
            DiffSet diffSet = comment1.Diff(comment2, Path.Empty, XmlEqualityOptions.IgnoreComments);
