...
{
    [TestsOn(typeof(RandomDoubleDataAttribute))]
    [RunSample(typeof(RandomDoubleDataSample))]
    public class RandomDoubleDataAttributeTest : BaseTestWithSampleRunner
    {
        ...
        {
            var run = Runner.GetPrimaryTestStepRun(CodeReference.CreateFromMember(typeof(RandomDoubleDataSample).GetMethod(testMethod)));
        ...
        public class RandomDoubleDataSample
        {
            [Test]
            public void Single([RandomDoubleData(Minimum = -10, Maximum = 10, Count = 100)] double value)
            {
