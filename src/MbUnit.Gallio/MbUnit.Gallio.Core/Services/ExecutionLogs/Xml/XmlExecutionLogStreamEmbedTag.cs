...
namespace MbUnit.Core.Services.ExecutionLogs.Xml
{
    ...
    [Serializable]
    public sealed class XmlExecutionLogStreamEmbedTag : XmlExecutionLogStreamTag
    {
        ...
        public static XmlExecutionLogStreamEmbedTag Create(string attachmentName)
        {
            XmlExecutionLogStreamEmbedTag tag = new XmlExecutionLogStreamEmbedTag();
