...
namespace MbUnit.Core.Services.ExecutionLogs.Xml
{
    ...
    public class XmlExecutionLogAttachment
    {
        private string name;
        private string contentType;
        private XmlExecutionLogAttachmentEncoding encoding;
        ...
        public XmlExecutionLogAttachmentEncoding Encoding
        {
            get { return encoding; }
            set { encoding = value; }
        }
        ...
        public static XmlExecutionLogAttachment Create(string attachmentName, string contentType,
            XmlExecutionLogAttachmentEncoding encoding, string innerText, XmlElement[] innerXml)
        {
            XmlExecutionLogAttachment tag = new XmlExecutionLogAttachment();
        ...
        public static XmlExecutionLogAttachment XmlSerialize(Attachment attachment)
        {
            XmlExecutionLogAttachmentSerializer serializer = new XmlExecutionLogAttachmentSerializer();
            attachment.Accept(serializer);
            return serializer.XmlExecutionLogAttachment;
        }

        /// <summary>
        /// Deserializes the attachment from Xml.
        /// </summary>
        /// <param name="xmlAttachment">The Xml execution log attachment</param>
        /// <returns>The deserialized form</returns>
        public static Attachment XmlDeserialize(XmlExecutionLogAttachment xmlAttachment)
        {
            ...
            switch (xmlAttachment.Encoding)
            {
                case XmlExecutionLogAttachmentEncoding.Xml:
                    {
                ...
                case XmlExecutionLogAttachmentEncoding.Text:
                    {
                ...
                case XmlExecutionLogAttachmentEncoding.Base64:
                    {
                        if (xmlAttachment.InnerText == null)
            ...
            throw new XmlException(String.Format(CultureInfo.CurrentCulture,
                "Unrecognized Xml content encoding '{0}'.", xmlAttachment.Encoding));
        }
    }
}
