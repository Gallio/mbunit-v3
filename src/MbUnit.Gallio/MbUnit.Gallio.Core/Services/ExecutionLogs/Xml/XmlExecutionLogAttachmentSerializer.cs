...
namespace MbUnit.Core.Services.ExecutionLogs.Xml
{
    ...
    /// </summary>
    public class XmlExecutionLogAttachmentSerializer : IAttachmentVisitor
    {
        private XmlExecutionLogAttachment xmlExecutionLogAttachment;

        /// <summary>
        /// Gets the serialized attachment.
        /// </summary>
        public XmlExecutionLogAttachment XmlExecutionLogAttachment
        {
            get { return xmlExecutionLogAttachment; }
        }

        /// <inheritdoc />
        public void VisitTextAttachment(TextAttachment attachment)
        {
            xmlExecutionLogAttachment = XmlExecutionLogAttachment.Create(attachment.Name, attachment.ContentType,
                XmlExecutionLogAttachmentEncoding.Text,
                attachment.Text, 
        ...
        {
            xmlExecutionLogAttachment = XmlExecutionLogAttachment.Create(attachment.Name, attachment.ContentType,
                XmlExecutionLogAttachmentEncoding.Xml,
                "",
        ...
        {
            xmlExecutionLogAttachment = XmlExecutionLogAttachment.Create(attachment.Name, attachment.ContentType,
                XmlExecutionLogAttachmentEncoding.Base64,
