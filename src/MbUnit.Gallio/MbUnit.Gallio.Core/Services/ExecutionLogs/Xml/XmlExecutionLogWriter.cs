...
namespace MbUnit.Core.Services.ExecutionLogs.Xml
{
    ...
    /// </summary>
    public class XmlExecutionLogWriter : IExecutionLogWriter
    {
        private XmlExecutionLog xmlExecutionLog;
        ...
        /// </summary>
        public XmlExecutionLogWriter()
        {
            xmlExecutionLog = XmlExecutionLog.Create();
        ...
        /// <summary>
        /// Gets the Xml execution log under construction.
        /// </summary>
        public XmlExecutionLog XmlExecutionLog
        {
            get { return xmlExecutionLog; }
        }
        ...
        public void WriteAttachment(string streamName, Attachment attachment)
        {
            ...
            lock (this)
            {
                ...
                else
                {
                    ...
                    xmlExecutionLog.AddAttachment(XmlExecutionLogAttachment.XmlSerialize(attachment));
                }
        ...
        private ExecutionLogStreamData GetStreamData(string streamName)
        {
            ...
            if (!streamDataMap.TryGetValue(streamName, out streamData))
            {
                ...
                xmlExecutionLog.AddStream(streamData.XmlExecutionLogStream);
            }
        ...
        {
            private XmlExecutionLogStream xmlExecutionLogStream;
            private Stack<XmlExecutionLogStreamContainerTag> containerStack;
            private StringBuilder textBuilder;

            public ExecutionLogStreamData(string streamName)
            {
                xmlExecutionLogStream = XmlExecutionLogStream.Create(streamName);
                containerStack = new Stack<XmlExecutionLogStreamContainerTag>();
                textBuilder = new StringBuilder();

                containerStack.Push(xmlExecutionLogStream.Body);
            }

            public XmlExecutionLogStream XmlExecutionLogStream
            {
                get { return xmlExecutionLogStream; }
            }
            ...
            public void Flush()
            {
                ...
                {
                    containerStack.Peek().AddContent(XmlExecutionLogStreamTextTag.Create(textBuilder.ToString()));
            ...
            public void WriteAttachment(string attachmentName)
            {
                ...
                containerStack.Peek().AddContent(XmlExecutionLogStreamEmbedTag.Create(attachmentName));
            }
            ...
            public void BeginSection(string sectionName)
            {
                ...
                XmlExecutionLogStreamSectionTag tag = XmlExecutionLogStreamSectionTag.Create(sectionName);
